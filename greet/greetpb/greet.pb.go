...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x88, 0x03, 0x0a, 0x0d, 0x47,
	0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x34, 0x0a, 0x05,
	...
	0x74, 0x68, 0x44, 0x65, 0x61, 0x64, 0x4c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	1,  // 5: greet.GreetServices.Greet:input_type -> greet.GreetRequest
	3,  // 6: greet.GreetServices.GreetManyTimes:input_type -> greet.GreetManyTimesRequest
	5,  // 7: greet.GreetServices.LongGreet:input_type -> greet.LongGreetRequest
	7,  // 8: greet.GreetServices.GreetEveryone:input_type -> greet.GreetEveryoneRequest
	9,  // 9: greet.GreetServices.GreetWithDeadLine:input_type -> greet.GreetWithDeadLineRequest
	2,  // 10: greet.GreetServices.Greet:output_type -> greet.GreetResponse
	4,  // 11: greet.GreetServices.GreetManyTimes:output_type -> greet.GreetManyTimesResponse
	6,  // 12: greet.GreetServices.LongGreet:output_type -> greet.LongGreetResponse
	8,  // 13: greet.GreetServices.GreetEveryone:output_type -> greet.GreetEveryoneResponse
	10, // 14: greet.GreetServices.GreetWithDeadLine:output_type -> greet.GreetWithDeadLineResponse
...
type GreetServicesClient interface {
	...
	GreetManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (GreetServices_GreetManyTimesClient, error)
	LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetServices_LongGreetClient, error)
	GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (GreetServices_GreetEveryoneClient, error)
...
func (c *greetServicesClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetServices/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greetServicesClient) GreetManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (GreetServices_GreetManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetServices_serviceDesc.Streams[0], "/greet.GreetServices/GreetManyTimes", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServicesGreetManyTimesClient{stream}
...
type GreetServices_GreetManyTimesClient interface {
	Recv() (*GreetManyTimesResponse, error)
	grpc.ClientStream
}

type greetServicesGreetManyTimesClient struct {
	grpc.ClientStream
}

func (x *greetServicesGreetManyTimesClient) Recv() (*GreetManyTimesResponse, error) {
...
func (c *greetServicesClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetServices_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetServices_serviceDesc.Streams[1], "/greet.GreetServices/LongGreet", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServicesLongGreetClient{stream}
	return x, nil
}

type GreetServices_LongGreetClient interface {
	Send(*LongGreetRequest) error
	CloseAndRecv() (*LongGreetResponse, error)
	grpc.ClientStream
}

type greetServicesLongGreetClient struct {
	grpc.ClientStream
}

func (x *greetServicesLongGreetClient) Send(m *LongGreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServicesLongGreetClient) CloseAndRecv() (*LongGreetResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (c *greetServicesClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (GreetServices_GreetEveryoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetServices_serviceDesc.Streams[2], "/greet.GreetServices/GreetEveryone", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServicesGreetEveryoneClient{stream}
	return x, nil
}

type GreetServices_GreetEveryoneClient interface {
	Send(*GreetEveryoneRequest) error
	Recv() (*GreetEveryoneResponse, error)
	grpc.ClientStream
}

type greetServicesGreetEveryoneClient struct {
	grpc.ClientStream
}

func (x *greetServicesGreetEveryoneClient) Send(m *GreetEveryoneRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServicesGreetEveryoneClient) Recv() (*GreetEveryoneResponse, error) {
...
func (c *greetServicesClient) GreetWithDeadLine(ctx context.Context, in *GreetWithDeadLineRequest, opts ...grpc.CallOption) (*GreetWithDeadLineResponse, error) {
	out := new(GreetWithDeadLineResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetServices/GreetWithDeadLine", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServicesServer interface {
	...
	GreetManyTimes(*GreetManyTimesRequest, GreetServices_GreetManyTimesServer) error
	LongGreet(GreetServices_LongGreetServer) error
	GreetEveryone(GreetServices_GreetEveryoneServer) error
...
func RegisterGreetServicesServer(s *grpc.Server, srv GreetServicesServer) {
	s.RegisterService(&_GreetServices_serviceDesc, srv)
}

func _GreetServices_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServicesServer).Greet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetServices/Greet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServicesServer).Greet(ctx, req.(*GreetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GreetServices_GreetManyTimes_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GreetManyTimesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GreetServicesServer).GreetManyTimes(m, &greetServicesGreetManyTimesServer{stream})
}

type GreetServices_GreetManyTimesServer interface {
	Send(*GreetManyTimesResponse) error
	grpc.ServerStream
}

type greetServicesGreetManyTimesServer struct {
	grpc.ServerStream
}

func (x *greetServicesGreetManyTimesServer) Send(m *GreetManyTimesResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _GreetServices_LongGreet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServicesServer).LongGreet(&greetServicesLongGreetServer{stream})
}

type GreetServices_LongGreetServer interface {
	SendAndClose(*LongGreetResponse) error
	Recv() (*LongGreetRequest, error)
	grpc.ServerStream
}

type greetServicesLongGreetServer struct {
	grpc.ServerStream
}

func (x *greetServicesLongGreetServer) SendAndClose(m *LongGreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServicesLongGreetServer) Recv() (*LongGreetRequest, error) {
...
func _GreetServices_GreetEveryone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServicesServer).GreetEveryone(&greetServicesGreetEveryoneServer{stream})
}

type GreetServices_GreetEveryoneServer interface {
	Send(*GreetEveryoneResponse) error
	Recv() (*GreetEveryoneRequest, error)
	grpc.ServerStream
}

type greetServicesGreetEveryoneServer struct {
	grpc.ServerStream
}

func (x *greetServicesGreetEveryoneServer) Send(m *GreetEveryoneResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServicesGreetEveryoneServer) Recv() (*GreetEveryoneRequest, error) {
...
func _GreetServices_GreetWithDeadLine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetWithDeadLineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServicesServer).GreetWithDeadLine(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetServices/GreetWithDeadLine",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServicesServer).GreetWithDeadLine(ctx, req.(*GreetWithDeadLineRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _GreetServices_serviceDesc = grpc.ServiceDesc{
	ServiceName: "greet.GreetServices",
	HandlerType: (*GreetServicesServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Greet",
			Handler:    _GreetServices_Greet_Handler,
		},
		{
			MethodName: "GreetWithDeadLine",
			Handler:    _GreetServices_GreetWithDeadLine_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GreetManyTimes",
			Handler:       _GreetServices_GreetManyTimes_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "LongGreet",
			Handler:       _GreetServices_LongGreet_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "GreetEveryone",
			Handler:       _GreetServices_GreetEveryone_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
